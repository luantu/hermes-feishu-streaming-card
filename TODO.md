...
- [ ] #282 Android/iOS 原审批卡展开和单次授权真机复测。
- [x] #305/#313 报告者确认 PR #310 话题路由实测通过（2026-09-17）。
- [x] #311 报告者确认 PR #310 实测通过（2026-09-17）；维护者另补重启提示分类回归。
- [ ] #306 报告者长会话升级复测。

## V4.5.2 跟进

- #318/#321：以本版发布门禁与报告者原场景复测分别记录。
- #282：报告者要求不再追踪，按 not planned 关闭。
- #319/#320：等待版本、运行状态及脱敏事件证据，保持开放。

## V4.6.0 集中稳定性

- [x] #323 撤回 profile/bot 路由与歧义拒绝。
- [x] #319 reasoning 独立通道、逐轮绑定与重复快照去重。
- [x] #310 总预算、脱敏日志、结束卡上下文及工具展示。
